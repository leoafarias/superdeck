...
import 'package:dashdeck_cli/src/builders/slide_data_builder.dart';
import 'package:dashdeck_cli/src/builders/slide_data_loader.dart';
...
class BuildCommand extends Command<int> {
  ...
  Future<int> run() async {
    ...
    Future<void> runBuildProcess() async {
      ...
      try {
        await buildSlideData(slidesData);
        progress.complete(
          'Build complete',
        );
      } catch (e) {
