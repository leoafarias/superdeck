...
import 'package:dash_deck_cli/src/command_runner.dart';
...
void main() {
  group('DashdeckCliCommandRunner', () {
    late PubUpdater pubUpdater;
    late Logger logger;
    late DashdeckCliCommandRunner commandRunner;
    ...
    setUp(() {
      ...
      commandRunner = DashdeckCliCommandRunner(
        logger: logger,
    ...
    test('can be instantiated without an explicit analytics/logger instance',
        () {
      final commandRunner = DashdeckCliCommandRunner();
